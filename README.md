...
* **[📂 /sql](./sql)** – Contains production-ready scripts. I focused on writing modular T-SQL using **CTEs** and **Window Functions** to ensure the logic is scalable and easy to audit.
* **[📂 /data](./data)** – Cleaned and normalized datasets (originally sourced from Our World in Data).
* **[📂 /dashboard](./dashboard)** – Tableau workbooks that translate thousands of rows into visual stories.
